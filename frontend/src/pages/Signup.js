...
function Signup(){
    ...
    const handleSignup= async(e)=>{
        ...
        try{
            const url=`https://deploymern-api-pied.vercel.app/auth/signup`;
        ...
        <div className='container'>
            ...
            <form onSubmit={handleSignup}>
                ...
                <div>
                    ...
                    <input onChange={handleChange} type='password'name='password' placeholder='Enter your Pasword....' value={signupInfo.password}/>
                </div>
